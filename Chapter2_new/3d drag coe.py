...
text(text='red ball -- smooth \ngreen ball -- normal\nblue ball -- rough',
     align='center', depth=-0.3, color=color.green, pos=(30,40,0),height=3,width=3) 
...
while True:
    ...
    if ball1.y >= 0:
        ...
        ball1.veloy -= co*(g+smooth(3.6*ball1.velo)*ball1.velo*ball1.velox)*deltat
    ...
    if ball2.y >= 0:
        ...
        ball2.veloy -= co*(g+smooth(3.6*ball2.velo)*ball2.velo*ball2.velox)*deltat
    ...
    if ball3.y >= 0:
        ...
        ball3.veloy -= co*(g+smooth(3.6*ball3.velo)*ball3.velo*ball3.velox)*deltat
