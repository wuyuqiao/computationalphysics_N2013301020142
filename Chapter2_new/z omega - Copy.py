...
x2,y2,z2 = array(data(0,0,100)[0]),array(data(0,0,100)[1]),array(data(0,0,100)[2])
x3,y3,z3 = array(data(0,0,500)[0]),array(data(0,0,500)[1]),array(data(0,0,500)[2])
x4,y4,z4 = array(data(0,0,1000)[0]),array(data(0,0,1000)[1]),array(data(0,0,1000)[2])
x5,y5,z5 = array(data(0,0,2000)[0]),array(data(0,0,2000)[1]),array(data(0,0,2000)[2])
